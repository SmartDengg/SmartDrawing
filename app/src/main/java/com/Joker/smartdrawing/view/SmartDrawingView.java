...
public class SmartDrawingView extends View {
  ...
  private void initTypeArray(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    TypedArray typedArray =
        context.obtainStyledAttributes(attrs, R.styleable.SmartDrawingView, defStyleAttr, defStyleRes);
    ...
    try {
      ...
      defaultStrokeWidth =
          typedArray.getDimensionPixelSize(R.styleable.SmartDrawingView_smart_stroke_width, DEFAULT_STROKE_WIDTH);
    } finally {
      typedArray.recycle();
    }
  }
